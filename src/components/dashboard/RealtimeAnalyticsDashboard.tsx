...
function RecentVisitorItem({ visitor }: { visitor: any }) {
...
function PerformanceAlert({ alert }: { alert: any }) {
...
function RealtimeOverview({ realtimeData }: { realtimeData: any }) {
  return (
...
function TrafficSources({ realtimeData }: { realtimeData: any }) {
...
function DeviceBreakdown({ realtimeData }: { realtimeData: any }) {
...
function GeographyView({ realtimeData }: { realtimeData: any }) {
