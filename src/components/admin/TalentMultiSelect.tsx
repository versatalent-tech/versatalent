...
export function TalentMultiSelect({
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-md shadow-lg max-h-72 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
          {/* Search Input */}
