    ...
    <MainLayout>
      <div className="bg-white py-16 md:py-24">
        <div className="container px-4 mx-auto">
          ...
          >
            <h1 className="text-4xl font-bold text-foreground mb-4">VersaTalent <span className="text-gold">Blog</span></h1>
            ...
            <Link href={`/blog/${blogPosts[0].id}`} className="block">
              <div className="relative rounded-lg overflow-hidden aspect-[16/9] shadow-lg">
                ...
                <div className="absolute bottom-0 left-0 p-6 md:p-8">
                  ...
                  <p className="text-gray-200 mb-4 max-w-3xl">{blogPosts[0].excerpt}</p>
                ...
                <Link href={`/blog/${post.id}`} className="block h-full">
                  <Card className="overflow-hidden bg-white border-gray-200 h-full hover:border-gold hover:shadow-md transition-all duration-300">
                    ...
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-bold text-foreground text-xl mb-2 line-clamp-2">{post.title}</h3>
          ...
          >
            <p className="text-gray-600 mb-2">Want more industry insights?</p>
            <Link
              href="/contact"
