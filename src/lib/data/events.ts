export type EventType = 'performance' | 'photoshoot' | 'match' | 'collaboration' | 'workshop' | 'appearance' | 'fashion show';
...
export const events: EventItem[] = [
  {
    ...
    talentIds: ["1"],
    imageSrc: "/images/events/Batida_Quente.avif",
    featured: false,
  ...
  },
  {
    ...
    talentIds: ["1"],
    imageSrc: "/images/events/Batida_Quente_Halloween.avif",
    featured: false,
