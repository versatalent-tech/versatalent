...
class AnalyticsAPI {
  ...
  static async getMetrics(talentId: string, filters?: Partial<AnalyticsFilters>): Promise<DashboardAnalytics> {
  ...
  static async getRealTimeMetrics(talentId: string): Promise<Record<string, unknown>> {
